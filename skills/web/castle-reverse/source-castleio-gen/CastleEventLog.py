...
EVENT_NAMES = {
    EVENT_CLICK: "EVENT_CLICK", EVENT_COPY: "EVENT_COPY", EVENT_CUT: "EVENT_CUT",
    EVENT_PASTE: "EVENT_PASTE", EVENT_COMPOSITIONEND: "EVENT_COMPOSITIONEND",
    EVENT_FOCUS: "EVENT_FOCUS", EVENT_BLUR: "EVENT_BLUR", EVENT_FOCUSIN: "EVENT_FOCUSIN",
    EVENT_FULLSCREEN: "EVENT_FULLSCREEN", EVENT_SELECT: "EVENT_SELECT", EVENT_PLAY: "EVENT_PLAY",
    EVENT_SEEKED: "EVENT_SEEKED", EVENT_VOLUMECHANGE: "EVENT_VOLUMECHANGE",
    EVENT_CONTEXTMENU: "EVENT_CONTEXTMENU", EVENT_DBLCLICK: "EVENT_DBLCLICK",
    EVENT_OFFLINE: "EVENT_OFFLINE", EVENT_ONLINE: "EVENT_ONLINE", EVENT_AFTERPRINT: "EVENT_AFTERPRINT",
    EVENT_ANIMATIONSTART: "EVENT_ANIMATIONSTART", EVENT_KEYDOWN: "EVENT_KEYDOWN",
    EVENT_TOUCH: "EVENT_TOUCH", EVENT_MOUSEMOVE: "EVENT_MOUSEMOVE", EVENT_AFK: "EVENT_AFK",
    EVENT_KEYDOWN3: "EVENT_KEYDOWN3", EVENT_VISIBILITYCHANGE: "EVENT_VISIBILITYCHANGE",
    EVENT_MOUSELEAVE: "EVENT_MOUSELEAVE", EVENT_MOUSEENTER: "EVENT_MOUSEENTER", EVENT_RESIZE: "EVENT_RESIZE",
}
