...
# Adapt for your site: pass the work dir as arg1, or set PX_WORK; defaults to ./samples/target
import os
ROOT = Path(sys.argv[1] if len(sys.argv) > 1 else os.environ.get("PX_WORK", "./samples/target"))
