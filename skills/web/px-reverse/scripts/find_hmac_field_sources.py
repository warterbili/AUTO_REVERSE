...
# Adapt for your site: pass the SDK js path as arg1, or set PX_SDK; defaults to ./samples/target/source/main.min.js
import os
SDK_PATH = Path(sys.argv[1] if len(sys.argv) > 1 else os.environ.get("PX_SDK", "./samples/target/source/main.min.js"))
